...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('nves', function (Blueprint $table) {
            ...
            $table->enum('estado', ['novo', 'rejeitado', 'cancelado', 'aprovado','recebido','entregue', 'inutilizada']);
            ...
            $table->boolean('enviado_email')->default(0);
            ...
            // alter table nves add column vendedor_id integer default null after enviado_email;
