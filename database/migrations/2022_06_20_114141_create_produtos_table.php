...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('produtos', function (Blueprint $table) {
            ...
            $table->boolean('chapa')->default(0);

            $table->boolean('nuvemshop')->default(0);
            ...
            $table->string('mercado_livre_composicao', 100)->nullable();
            $table->string('mercado_livre_linha', 100)->nullable();

            $table->text('mercado_livre_descricao');
            $table->string('mercado_livre_status', 20);

            //Variaveis para o NuvemShop
            ...
            // alter table produtos add column diametro decimal(8, 2) default null;
            ...
            // alter table produtos add column nuvemshop boolean default 0;
