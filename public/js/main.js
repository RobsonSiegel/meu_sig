...
$(function () {
    ...
    .append('<button type="button" ' +
        'class="btn btn-link btn-tooltip3 btn-sm" ' +
        'data-toggle="tooltip" data-placement="top" ' +
        'title="Tooltip on top"><i class="ri-file-info-fill"></i></button>')
    ...
    $("input.tooltipp4, select.tooltipp4, textarea.tooltipp4")
        .siblings("label")
        .append('<button type="button" ' +
            'class="btn btn-link btn-tooltip4 btn-sm" ' +
            'data-toggle="tooltip" data-placement="top" ' +
            'title="Tooltip on top"><i class="ri-file-info-fill"></i></button>')
    ...
    $("input.tooltipp5, select.tooltipp5, textarea.tooltipp5")
        .siblings("label")
        .append('<button type="button" ' +
            'class="btn btn-link btn-tooltip5 btn-sm" ' +
            'data-toggle="tooltip" data-placement="top" ' +
            'title="Tooltip on top"><i class="ri-file-info-fill"></i></button>')

    if($('.text-tooltip5')){
        let texto = $('.text-tooltip5').html()

        $('.btn-tooltip5').prop('title', texto)
        $('.btn-tooltip5').tooltip()
    }
...
$(".btn-delete").on("click", function (e) {
    ...
    console.log('Form selecionado' + form);
