...
! function (l) {
    ...
    function e() {
        this.$body = l("body"), this.$modal = new bootstrap.Modal(document.getElementById("event-modals"), {
            backdrop: "static"
        }), this.$calendar = l("#calendar"), this.$formEvent = l("#form-event"), this.$btnNewEvent = l("#btn-new-event"), this.$btnDeleteEvent = l("#btn-delete-event"), this.$btnSaveEvent = l("#btn-save-event"), this.$modalTitle = l("#modals-title"), this.$calendarObj = null, this.$selectedEvent = null, this.$newEventData = null
    }
...
function setModalFuncionario(){
    $("#inp-funcionario_id").select2({
        ...
        theme: "bootstrap4",
        dropdownParent: $('#event-modals .modals-content'),
        ajax: {
            cache: true,
