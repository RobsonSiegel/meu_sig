...
class EstoqueUtil
{
    public function incrementaEstoque($produto_id, $quantidade, $produto_variacao_id, $local_id = null)
    {
        ...
        if ($produto->combo) {
            foreach ($produto->itensDoCombo as $c) {
                $this->incrementaEstoque($c->item_id, $c->quantidade * $quantidade);
            }
        } else {
            if ($item != null) {
    ...
    public function reduzEstoque($produto_id, $quantidade, $produto_variacao_id = null, $local_id = null)
    {
        ...
        if ($item != null) {
            ...
            if ($produto->combo) {
                foreach ($produto->itensDoCombo as $c) {
                    $this->reduzEstoque($c->item_id, $c->quantidade * $quantidade);
                }
            } else {
