...
class EmpresaUtil
{
    ...
    public function createSetores($empresa_id)
    {
        $setores = [
            'Padrão Desenho',
            'Padrão Corte',
    ...
    public function createMaquinas($empresa_id)
    {
        $maquinas = [
            'Padrão Desenho',
            'Padrão Corte',
    ...
    public function createSequenciaPadrao($empresa_id)
    {
        SequenciaPadrao::create([
            'empresa_id' => $empresa_id,
            'status' => 1,
