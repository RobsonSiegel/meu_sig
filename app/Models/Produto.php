...
class Produto extends Model
{
    ...
    protected $fillable = [
        ...
        'largura', 'comprimento', 'altura', 'peso', 'ecommerce', 'nuvemshop','destaque_ecommerce', 'hash_ecommerce', 'texto_ecommerce',
        ...
        'woocommerce_status', 'woocommerce_descricao', 'woocommerce_stock_status', 'categorias_woocommerce',
        /* Campos Novos Chapa*/
        'chapa', 'espessura', 'diametro'
    ];
    ...
    public function estoqueVariacao(){
        $estoque = 0;
        foreach($this->variacoes as $v){
            $estoque = $estoque + $v->estoque_variacao;
        }
        return $estoque;
    }
