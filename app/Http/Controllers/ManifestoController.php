...
class ManifestoController extends Controller
{
    ...
    public function download($id)
    {
        ...
        if ($naturezaPadrao == null) {
            session()->flash('flash_error', 'Cadastre uma natureza de operação!');
    ...
    private function renderizaXml($xml){
        ...
        $tipo_pagamentos = NFe::tiposPagamento();
        ...
        return view('compras.import_xml', compact('dadosXml', 'transportadoras', 'cidades', 'naturezas', 'fornecedor','produtos', 'tipo_pagamentos'));
