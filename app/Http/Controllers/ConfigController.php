    ...
    public function store(Request $request)
    {
        ...
        try {
            DB::transaction(function () use ($request, $plano) {
                ...
                //Alteração para criar Natureza de Operações Padrão.
                $nat_compra = NaturezaOperacao::create([
                    'empresa_id' => $empresa->id,
                    'descricao' =>'Compra de Mercadorias (Entrada)'
                ]);

                $nat_venda = NaturezaOperacao::create([
                    'empresa_id' => $empresa->id,
                    'descricao' =>'Venda de Mercadorias (Saída)'
                ]);
                return true;
            });
