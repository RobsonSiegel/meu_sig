...
class ClienteController extends Controller
{
    ...
    public function transformaFornecedor($id){

        $cliente = Cliente::findOrFail($id);
        $fornecedor = Fornecedor::where('cpf_cnpj', $cliente->cpf_cnpj)->first();
        ...
        if (!$fornecedor){
            ...
            session()->flash("flash_success", "Fornecedor já cadastrado!");
        }
