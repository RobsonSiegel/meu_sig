...
use App\Models\User;
use App\Utils\ImpressaoAutoUtil;
...
class NfceController extends Controller
{
    ...
    protected $imprimiAutoUtil;

    public function __construct(EstoqueUtil $util, ImpressaoAutoUtil $imprimiAutoUtil)
    {
        $this->util = $util;
        $this->imprimiAutoUtil = $imprimiAutoUtil;
    ...
    public function imprimir($id)
    {
        ...
        if (file_exists(public_path('xml_nfce/') . $item->chave . '.xml')) {
            ...
            if ($configUsuario->nome_impressora) {
                $imprimiAuto = new ImpressaoAutoUtil();
                $retorno = $imprimiAuto->imprimeNFCe($pdf, $configUsuario->nome_impressora);
                if ($retorno == 'OK') {
