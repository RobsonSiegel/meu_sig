...
class FornecedorController extends Controller
{
    ...
    public function transformaCliente($id){

        $fornecedor = Fornecedor::findOrFail($id);
        $cliente = Cliente::where('cpf_cnpj', $fornecedor->cpf_cnpj)->first();
        ...
        if (!$cliente){
            $data  = [
                ...
                'consumidor_final' => $fornecedor->consumidor_final,
            ...
            session()->flash("flash_success", "Cliente já cadastrado!");
        }
