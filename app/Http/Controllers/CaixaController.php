...
class CaixaController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($item != null) {
            ...
            $contasEmpresa = ContaEmpresa::where('empresa_id', request()->empresa_id)->count();
    ...
    public function fechar(Request $request)
    {
        ...
        try {
            ...
            //Inicio Bruno - Ticket: 5125
            $item->valor_cartao_credito = $request->valor_cartao_credito ? __convert_value_bd($request->valor_cartao_credito) : 0;
            $item->valor_cartao_debito = $request->valor_cartao_debito ? __convert_value_bd($request->valor_cartao_debito) : 0;
            $item->valor_pix = $request->valor_pix ? __convert_value_bd($request->valor_pix) : 0;
            //Fim Bruno
    ...
    public function imprimir($id)
    {
        ...
        //Modelo Folha A4
        if ($configGeral->tipo_imp_fechamento_caixa == '01'){
        ...
        //Modelo Impressora Cupom
        if ($configGeral->tipo_imp_fechamento_caixa == '02'){
            $p = view('caixa.imprimir_cupom', compact(
                'item',
                'vendas',
                'usuario',
                'somaTiposPagamento',
