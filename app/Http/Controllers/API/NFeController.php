...
class NFeController extends Controller
{
    ...
    private function criaItens($itens, $nfe_id, $empresa_id)
    {
        foreach ($itens as $i) {
            ...
            ItemNfe::create([
                ...
                //'vl_base_icms' => isset($i['vl_base_icms']) ? __convert_value_bd($i['vl_base_icms']) : 0,
    ...
    public function inutilizarDireto(Request $request)
    {
        ...
        try {
            $data = [
                ...
                'numero_inicial' => $nfe->numero,
                'numero_final' => $nfe->numero,
                'numero_serie' => $nfe->numero_serie,
                'modelo' => '55',
        ...
        $nfe = DB::transaction(function () use ($request) {
            ...
            for ($i = 0; $i < sizeof($item->itens); $i++) {
                ...
                ItemNfe::create([
                    ...
                    //'vl_base_icms' => __convert_value_bd($item->itens[$i]->vl_base_icms),
