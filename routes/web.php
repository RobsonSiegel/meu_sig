...
Route::get('/', function () {
    if (getenv('APP_ENV') == 'local') {
        ...
        return redirect('https://lp.meusig.com.br/');
    }
...
Route::middleware(['authh', 'validaEmpresa'])->group(function () {
    ...
    Route::middleware(['verificaMaster'])->group(function () {
        ...
        Route::post('roles-atribuir-atribuicao', 'RoleController@inserirAtribuicaoEmpresa')->name('roles.inserir-atribuicao-empresa');
    ...
    /* Inicio Bruno - Alteração para enviar o email do cliente */
    Route::get('nfe/enviar-email/{id}', 'NfeController@enviarEmail')->name('nfe.enviar-email');
    ...
    Route::get('nfce-imprimir-auto/{id}', 'NfceController@imprimirAuto')->name('nfce.imprimir-auto');
    ...
    Route::get('/nfe/informa-entrega/{id}', 'NfeController@informaEntrega')->name('nfe.informa-entrega');
    Route::post('/nfe/setar-info-entrega', 'NfeController@setarInfoEntrega')->name('nfe.setar-info-entrega');
    ...
    Route::get('boleto-enviar-email/{id}', 'BoletoController@enviarEmail')->name('boleto.enviar-email');
    ...
    Route::middleware(['verificaEmpresa', 'validaPlano'])->group(function () {
        ...
        Route::get('/compras/informa-recebimento/{id}', 'CompraController@informaRecebimento')->name('compras.informa-recebimento');
        Route::post('/compras/setar-info-recebimento', 'CompraController@setarInfoRecebimento')->name('compras.setar-info-recebimento');

        Route::post('/compras/busca-numero-compra', 'CompraController@buscarNumeroCompra')->name('compras.buscar-numero-compra');

        Route::get('/compras/imprimir-compra/{id}', 'CompraController@imprimirCompra')->name('compras.imprimir-compra');

        Route::get('/compras/enviar-email/{id}', 'CompraController@enviarEmail')->name('compras.enviar-email');
        ...
        Route::get('clientes-transforma-fornecedor/{id}', 'ClienteController@transformaFornecedor')->name('clientes.transforma-fornecedor');
        ...
        Route::get('fornecedores-transforma-cliente/{id}', 'FornecedorController@transformaCliente')->name('fornecedores.transforma-cliente');
        ...
        Route::group(['prefix' => 'usuarios'], function () {
            ...
            Route::get('testar_envio/{id}', 'UsuarioController@teste')->name('usuarios.testar_envio');
        });
        ...
        /* Inicio Bruno - criação de prototipo da tela de pedido chapa */
        Route::resource('pedidos', 'PedidoController');
        Route::get('pedidos-galery/{id}', 'PedidoController@galery')->name('pedidos.galery');

        // Módulo de Chapas
        // Inicio Bruno
        Route::resource('setor', 'SetorController');
        Route::delete('setor-destroy-select', 'SetorController@destroySelecet')->name('setor.destroy-select');
        Route::resource('maquinas', 'MaquinaController');
        Route::delete('maquinas-destroy-select', 'MaquinaController@destroySelecet')->name('maquinas.destroy-select');
        Route::resource('seqpadrao', 'SequenciaPadraoController');
        Route::delete('seqpadrao-destroy-select', 'SequenciaPadraoController@destroySelecet')->name('seqpadrao.destroy-select');
        /* Fim Bruno */
        ...
        Route::group(['prefix' => 'relatorios'], function () {
            ...
            // Relatório de Produtos Negativos - Adicionado em 24/07/2024 - Solicitação do Robson
            Route::get('relatorio-produtos_negativos', 'RelatorioController@produtosNegativos')->name('relatorios.produtos_negativos');
