...
Route::get('/busca-config-geral/{id}', 'HelperController@buscaConfigGeral');
...
Route::middleware(['valid'])->group(function () {
    Route::group(['prefix' => 'nfe'], function () {
        ...
        Route::post('/inutilizar-direto', 'NFeController@inutilizarDireto');
...
Route::group(['prefix' => 'nfce_painel'], function () {
    ...
    Route::post('/inutilizar', 'NFCePainelController@inutilizar');
...
Route::group(['prefix' => 'produtos'], function () {
    ...
    Route::get('/getVariacoes/{id}', 'ProdutoController@getVariacoes');
    Route::get('/getValorVariacao/{id}', 'ProdutoController@getValorVariacao');
    ...
    Route::post('/pesquisa-codigo-barras', 'ProdutoController@pesquisaCodigoBarra');
    Route::post('/atualiza-estoque', 'ProdutoController@atualizaEstoque');

    /* Função criada para retornar os produtos para o PDV Delphi */
    /* Inicio Bruno */
    Route::post('/busca-produto-pdv', 'ProdutoController@buscaProdutoPDV');
    /* Fim Bruno */

    Route::get('/get-natureza-operacao', 'ProdutoController@getNaturezaOperacao');
...
Route::group(['prefix' => 'usuarios'], function () {
    ...
    Route::post('/retorna-usuarios', 'UserController@retornaUsuarios');
});
...
Route::group(['prefix' => 'compras'], function () {
    Route::post('/buscar-numero-compra', 'CompraController@buscarNumeroCompra');
    Route::get('/find/{id}', 'CompraController@find');
});
...
Route::group(['prefix' => 'delivery-link'], function () {
    ...
    // novo
    Route::get('/produto-modals/{hash}', 'Delivery\\ProdutoController@produtoModal')->name('produto-delivery.modals');
    ...
    Route::get('/carrinho-modals', 'Delivery\\CarrinhoController@carrinhoModal')->name('carrinho.modals');
...
Route::group(['prefix' => 'pdv'], function () {
    ...
    Route::post('/usuarios', 'PDV\\LoginController@usuarios');
    ...
    Route::post('/dados-empresa-post', 'PDV\\LoginController@dadosEmpresa');
