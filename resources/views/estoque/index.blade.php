                ...
                <div class="card-body">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-3">
                                {!!Form::text('referencia', 'Pesquisar por referência')
                                !!}
                            </div>
                            <div class="col-md-3 text-left ">
                                ...
                                <a id="clear-filter" class="btn btn-danger" href="{{ route('estoque.index') }}"><i
                            ...
                            <table class="table table-striped table-centered mb-0">
                                ...
                                @forelse($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            @if(!$item->produto->variacao_modelo_id)
                                                ...
                                                @endif
                                            @else
                                                {{ __moeda($item->produtoVariacao->estoque_variacao) }}
                                            @endif
                                        </td>
                                        <td>
                                            @if(!$item->produto->variacao_modelo_id)
                                        ...
                                        <td style="width: 300px">
                                            @can('estoque_edit')
                                                <a href="{{ route('estoque.edit', [$item->id]) }}"
                                                   class="btn btn-dark btn-sm">Editar estoque</a>
                                            @endcan
                                            @can('produtos_edit')
                                                <a href="{{ route('produtos.edit', [$item->produto_id]) }}"
                                                   class="btn btn-warning btn-sm">Editar produto</a>
                                            @endcan
