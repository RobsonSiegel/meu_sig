        ...
        <div class="card-body d-flex flex-column h-100 gap-3">
            ...
            <div class="auth-brand text-center text-lg-start logo-mob">
                <a href="index.html" class="logo-dark">
                    <span><img style="margin-top: 100px" src="/logo2.png" alt="dark logo"></span>
                </a>
            </div>
            <div class="my-auto">
                <!-- title-->
                <h4 class="mt-3">Cadastre-se</h4>
                <p class="text-muted mb-4">Preencha as informações abaixo para poder acessar a plataforma e realizar seu teste grátis por até 10 dias</p>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-3">
                        <input class="form-control fone"  id="telefone" type="number" placeholder="Telefone" required name="telefone">
                        @error('telefone')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
