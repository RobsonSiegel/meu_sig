                            ...
                            <div class="col-md-5">
                                ...
                                <div class="input-group flex-nowrap">
                                    <select id="inp-fornecedor_id" name="fornecedor_id" class="fornecedor_id">
                                        @isset($cotacao)
                                            <option
                                                value="{{ $cotacao->fornecedor_id }}">{{ $cotacao->fornecedor->razao_social }}</option>

                                        @else
                                            @isset($item)
                                                <option
                                                    value="{{ $item->fornecedor_id }}">{{ $item->fornecedor->razao_social }}</option>
                                            @endif
                                        @endif
                                    ...
                                    @can('fornecedores_create')
                                        <button class="btn btn-dark" data-bs-toggle="modal"
                                                data-bs-target="#modal_novo_fornecedor" type="button">
                                            <i class="ri-add-circle-fill"></i>
                                        </button>
                                    @endcan
                                </div>
                            ...
                            <div class="row d-cliente">
                                ...
                                <div class="col-md-4 mt-3">
                                    ...
                                    <select required class="form-control select2 cidade_id" name="fornecedor_cidade"
                                        ...
                                        <option value="">Selecione..</option>
                                        @foreach ($cidades as $c)
                                            <option @isset($item) @if($item->fornecedor->cidade_id == $c->id) selected
                                                    @endif @endisset value="{{$c->id}}">{{$c->nome}}
                                                - {{$c->uf}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <table class="table table-dynamic table-produtos" style="width: 2800px">
                                ...
                                @if(isset($item))
                                    ...
                                    @foreach ($item->itens as $prod)
                                        ...
                                        @isset($isOrdemServico)
                                            @include('FontesVersaoSLYM.resources.views.ordem_servico.partials.itens', ['prod' => $prod])
                                        @elseif(isset($isPedidoEcommerce))
                                            @include('FontesVersaoSLYM.resources.views.pedido_ecommerce.partials.itens', ['prod' => $prod, 'cfop_estadual' => $item->cliente->cidade->uf])
                                        @elseif(isset($isPedidoMercadoLivre))
                                            @include('FontesVersaoSLYM.resources.views.mercado_livre_pedidos.partials.itens', ['prod' => $prod, 'cfop_estadual' => $item->cliente->cidade->uf])

                                        @elseif(isset($isReserva))
                                            @include('FontesVersaoSLYM.resources.views.mercado_livre_pedidos.partials.itens', ['prod' => $prod, 'cfop_estadual' => $item->cliente->cidade->uf])
                                        @elseif(isset($isPedidoWoocommerce))
                                            @include('FontesVersaoSLYM.resources.views.woocommerce_pedidos.partials.itens', ['prod' => $prod, 'cfop_estadual' => $item->cliente->cidade->uf])
                                        ...
                                        @else
                                            <tr class="dynamic-form">
                                                ...
                                                <td width="80">
                                                    <input style="width: 150px" value="{{ __moeda($prod->quantidade) }}"
                                                           class="form-control qtd" type="tel" name="quantidade[]"
                                                           id="inp-quantidade">
                                                </td>
                                                <td width="100">
                                                    <input style="width: 150px"
                                                           value="{{ __moeda($prod->valor_unitario) }}"
                                                ...
                                                <td width="120">
                                                    <input style="width: 120px"
                                                           ...
                                                           class="form-control ignore codigo_beneficio_fiscal"
                                                ...
                                                <td>
                                                    <select name="cst_csosn[]" class="form-control select2">
                                                        @foreach(App\Models\Produto::listaCSTCSOSN() as $key => $c)
                                                            <option @if($prod->cst_csosn == $key) selected
                                                ...
                                                <td>
                                                    <select name="cst_pis[]" class="form-control select2">
                                                        @foreach(App\Models\Produto::listaCST_PIS_COFINS() as $key => $c)
                                                            <option @if($prod->cst_pis == $key) selected
                                                                    @endif value="{{$key}}">{{$c}}</option>
                                                        @endforeach
                                                    </select>
                                                    <div style="width: 400px"></div>
                                                ...
                                                <td>
                                                    <select name="cst_cofins[]" class="form-control select2">
                                                        @foreach(App\Models\Produto::listaCST_PIS_COFINS() as $key => $c)
                                                            <option @if($prod->cst_cofins == $key) selected
                                                                    @endif value="{{$key}}">{{$c}}</option>
                                                        @endforeach
                                                    </select>
                                                    <div style="width: 400px"></div>
                                                ...
                                                <td>
                                                    <select name="cst_ipi[]" class="form-control select2">
                                                        @foreach(App\Models\Produto::listaCST_IPI() as $key => $c)
                                                            <option @if($prod->cst_ipi == $key) selected
                                                                    @endif value="{{$key}}">{{$c}}</option>
                                                        @endforeach
                                                    </select>
                                                    <div style="width: 400px"></div>
                                                ...
                                                <td>
                                                    <input class="form-control" value="{{ $prod->xPed }}" maxlength="15"
                                                           type="text" name="xPed[]">
                                                    <div style="width: 200px"></div>
                                                </td>
                                                <td>
                                                    <input class="form-control" value="{{ $prod->nItemPed }}"
                                ...
                                @elseif(isset($cotacao))
                                    @foreach ($cotacao->itens as $prod)
                                        @include('FontesVersaoSLYM.resources.views.cotacoes.partials.itens', ['prod' => $prod, 'mesmo_estado' => $cotacao->fornecedor->cidade->uf == $empresa->cidade->uf])
                                    @endforeach
                                ...
                                @else
                                    <tr class="dynamic-form">
                                        ...
                                        <td width="150">
                                            <input style="width: 120px" class="form-control moeda valor_unit" type="tel"
                                                   name="valor_unitario[]" id="inp-valor_unitario">
                                        </td>
                                        <td width="150">
                                            <input style="width: 120px" readonly class="form-control moeda sub_total"
