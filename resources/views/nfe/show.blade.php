            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <h4>Estado:
                        ...
                        @elseif($data->estado == 'entregue')
                            <span class="text-info">Entregue</span>
                        @elseif($data->estado == 'inutilizada')
                            <span class="text-dark">Inutilizada</span>
                        @else
