<div class="leftside-menu">
    <!-- Brand Logo Light -->
    <a href="/home" class="logo logo-light" style="margin-bottom: 45px">
        <span class="logo-lg">
    ...
    <!-- Brand Logo Dark -->
    <a href="/home" class="logo logo-dark" style="margin-bottom: 25px;margin-top: 25px">
        <span class="logo-lg">
    ...
    <div class="h-100" id="leftside-menu-container" data-simplebar>
        ...
        <!--- Sidemenu -->
        <ul class="side-nav" id="step4" style="margin-bottom: 60px">
