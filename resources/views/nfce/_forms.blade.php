                            ...
                            <table class="table table-dynamic table-produtos" style="width: 2800px">
                                ...
                                <tbody>
                                    ...
                                    <tr class="dynamic-form">
                                        ...
                                        <td width="150">
                                            <input value="{{ $prod->ncm }}" class="form-control ncm ignore" type="tel" name="ncm[]" id="inp-ncm2">
                                        </td>
{{--                                        <td width="150">--}}
{{--                                            <input value="{{ $prod->ncm }}" class="form-control ncm ignore" type="tel" name="ncm[]" id="inp-ncm">--}}
{{--                                        </td>--}}
                                        <td width="120">
                                    ...
                                    <tr class="dynamic-form">
                                        ...
                                        <td width="150">
                                            <input class="form-control ncm ignore" type="tel" name="ncm[]" id="inp-ncm">
                                        </td>
                                        <td width="120">
