                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-2">
                                ...
                                <a id="clear-filter" class="btn btn-danger" href="{{ route('nfce.index') }}"><i
                            ...
                            <table class="table table-striped table-centered mb-0">
                                ...
                                @forelse($data as $item)
                                    <tr>
                                        ...
                                        <td width="380">
                                            <form action="{{ route('nfce.destroy', $item->id) }}" method="post"
                                                  id="form-{{$item->id}}">
                                                @method('delete')
                                                @csrf
                                                ...
                                                {{-- Imprimir NFCe --}}
                                                @if($item->estado == 'aprovado')
                                                    <a class="btn btn-primary btn-sm" title="Imprimir NFCe"
                                                    ...
                                                    {{-- Cancelar a NFCe --}}
                                                    @can('nfce_transmitir')
                                                        <button title="Cancelar NFCe" type="button"
                                                ...
                                                @if($item->estado == 'rejeitado')
                                                    <button title="Consultar Chave" type="button"
                                                ...
                                                @if($item->estado === 'novo' || $item->estado === 'rejeitado')
                                                    ...
                                                    @can('nfce_edit')
                                                        <a class="btn btn-warning btn-sm"
                                                           href="{{ route('nfce.edit', $item->id) }}">
                                                            <i class="ri-edit-line"></i>
                                                        </a>
                                                    @endcan

                                                    {{-- Gerar XML Temporário --}}
                                                    <a title="XML temporário" class="btn btn-light btn-sm"
                                                    ...
                                                    <button title="Inutilizar NFCe" type="button"
                                                ...
                                                @if ($item->estado === 'rejeitado')
                                                    @can('nfce_edit')
                                                        <a title="Alterar estado fiscal" class="btn btn-warning btn-sm"
                                                           href="{{ route('nfce.alterar-estado', $item->id) }}">
                                                ...
                                                <a class="btn btn-ligth btn-sm" title="Detalhes"
                                                   href="{{ route('nfce.show', $item->id) }}"><i
                                                        class="ri-eye-line"></i></a>

                                                {{-- Danfce Temporária --}}
                                                @if($item->estado == 'rejeitado')
                                                    <a class="btn btn-danger btn-sm" title="DANFCE Temporária"
                                                       target="_blank"
                                                       href="{{ route('nfce.danfce-temporaria', [$item->id]) }}">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Cancelar NFCe <strong class="ref-numero"></strong>
                    </h5>
    ...
    <div class="modal fade" id="modal-inutilizar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Inutilizar NFCe <strong class="ref-numero"></strong>
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            {!!Form::text('motivo-inutilizacao', 'Motivo')
                            ->required()
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">Fechar</button>
                    <button type="button" id="btn-inutilizar" class="btn btn-danger">Inutilizar</button>
                </div>
            </div>
        </div>
    </div>
