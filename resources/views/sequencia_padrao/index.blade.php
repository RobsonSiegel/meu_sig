@extends('layouts.app', ['title' => 'Sequência Padrão'])
@section('content')
    <div class="mt-3">
        <div class="row">
            <div class="card">
                <div class="card-body">
                    <div class="col-md-2">
                        @can('seqpadrao_create')
                            <a href="{{ route('seqpadrao.create') }}" class="btn btn-success">
                                <i class="ri-add-circle-fill"></i>
                                Nova Sequência Padrão
                            </a>
                        @endcan
                    </div>
                    <hr class="mt-3">
                    <div class="col-lg-12">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-3 text-left ">
                                ...
                                <a id="clear-filter" class="btn btn-danger" href="{{ route('seqpadrao.index') }}"><i
                    ...
                    <div class="col-md-12 mt-3">
                        <div class="table-responsive-sm">
                            <table class="table table-striped table-centered mb-0">
                                ...
                                @forelse($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('seqpadrao.destroy', $item->id) }}" method="post"
                                                  id="form-{{$item->id}}">
                                                @method('delete')
                                                @can('maquina_edit')
                                                    <a class="btn btn-warning btn-sm text-white"
                                                       href="{{ route('seqpadrao.edit', [$item->id]) }}">
                            ...
                            <br>
                            @can('seqpadrao_delete')
                                <form action="{{ route('seqpadrao.destroy-select') }}" method="post"
