                        ...
                        <div class="m-2">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        {!!Form::select('abrir_modal_cartao', 'Abrir modals dados do cartão', ['1' => 'Sim', '0' => 'Não'])->attrs(['class' => 'form-select'])
                                        !!}
                                    </div>
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-3">
                                        {!!Form::select('mostra_campos_extra_fechamento_caixa', 'Mostra campos extras Fechamento Caixa', ['0' => 'Não', '1' => 'Sim'])->attrs(['class' => 'form-select'])
                                        !!}
                                    </div>
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-3">
                                        {!!Form::select('usa_caixa_cego', 'Usa Caixa Cego', ['0' => 'Não', '1' => 'Sim'])->attrs(['class' => 'form-select'])
                                        !!}
                                    </div>
                                    <div class="col-md-3">
                                        {!!Form::select('tipo_imp_fechamento_caixa', 'Tipo Fechamento de Caixa', ['01' => 'Folha A4', '02' => 'Impressora Cupom'])->attrs(['class' => 'form-select'])
                                        !!}
                                    </div>
                                    <div class="col-md-2">
                                        {!!Form::tel('percentual_maximo_desconto', '% Máximo Desconto')
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        {!!Form::select('movimenta_estoque_entrega', 'Movimenta Estoque na Entrega', ['0' => 'Não', '1' => 'Sim'])->attrs(['class' => 'form-select'])
                                        !!}
                                    </div>
                                </div>
                            </div>
