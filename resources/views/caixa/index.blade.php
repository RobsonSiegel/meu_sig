    ...
    <div class="mt-3">
        <div class="row">
            <div class="card">
                ...
                @else
                    @if(!$config->usa_caixa_cego)
                        <div class="card-body">
                            <div class="card-body mt-1">
                                <div class="bg-light-subtle border-top border-bottom border-light">
                                    <div class="row text-center">
                                        @if(__countLocalAtivo() > 1)
                                            <h5 class="mt-2">Local: <strong
                                                    class="text-danger">{{ $item->localizacao ? $item->localizacao->descricao : '' }}</strong>
                                            </h5>
                                        @endif
                                        <div class="col">
                                        ...
                                        <div class="col">
                                            <p class="text-muted mt-3"><i class="ri-file-list-2-line"></i> Data de
                                                Abertura
                                            </p>
                                            <h3 class="fw-normal mb-3">
                                        ...
                                        <div class="col">
                                            <p class="text-muted mt-3"><i class="ri-money-dollar-circle-line"></i> Valor
                                                de
                                                Abertura</p>
                                            <h3 class="fw-normal mb-3">
                                        ...
                                        @if($item->contaEmpresa)
                                            <div class="col">
                                                <p class="text-muted mt-3"><i class="ri-money-dollar-circle-line"></i>
                                                    Conta
                                                </p>
                                                <h3 class="fw-normal mb-3">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="row text-center mt-4">
                                    <div class="col-md-4 card">
                                        <h3>Total de vendas: <strong class="text-danger">{{ __moeda($soma) }}</strong>
                                        </h3>
                                    </div>
                                    <div class="col-md-4 card">
                                        <h3>Venda de produtos: <strong
                                                class="text-danger">{{ __moeda($soma-$somaServicos) }}</strong></h3>
                                    </div>

                                    <div class="col-md-4 card">
                                        <h3>Venda de serviços: <strong
                                                class="text-danger">{{ __moeda($somaServicos) }}</strong></h3>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row m-3">
                            <div class="col-md-4">
                                <h3>Total Entrada:
                                    <strong
                                        class="text-primary">R$ {{ __moeda($soma + $somaSuprimento + $receber->sum('valor_integral')) }}</strong>
                                </h3>
                            </div>
                            <div class="col-md-4">
                                <h3>Total Saída:
                                    <strong
                                        class="text-primary">R$ {{ __moeda($somaSangria + $pagar->sum('valor_integral')) }}</strong>
                                </h3>
                            </div>
                            <div class="col-md-4">
                                <h3>Saldo: <strong
                                        class="text-success">R$ {{ __moeda($soma + $somaSuprimento + $valor_abertura + $receber->sum('valor_integral') - $somaSangria - $pagar->sum('valor_integral')) }}</strong>
                                </h3>
                            </div>
                        </div>
                        <div class="col-md-3 m-3">
                            ...
                            @if($contasEmpresa == 0)
                                <button class="btn btn-danger" data-bs-toggle="modal"
                                        data-bs-target="#fechamento_caixa">
                                    <i class="ri-add-circle-fill"></i>
                                    Fechar Caixa
                                </button>
                            @else
