                ...
                <div class="row mt-3">
                    ...
                    <div class="row m-3">
                        ...
                        <div class="col-12 col-md-3">
                            ...
                            <h4>Valor em Cartão Crédito: <strong class="text-danger">R$ {{ __moeda($item->valor_cartao_credito) }}</strong></h4>
                            <h4>Valor em Cartão Débito: <strong class="text-danger">R$ {{ __moeda($item->valor_cartao_debito) }}</strong></h4>

                        </div>
                        <div class="col-12 col-md-3">
                            <h4>Valor em Pix: <strong class="text-danger">R$ {{ __moeda($item->valor_pix) }}</strong></h4>
