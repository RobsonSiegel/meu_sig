...
<header>
    <div>
        <img style="margin-top: -20px" src="{{'data:image/png;base64,' . base64_encode(file_get_contents(@public_path('logo.png')))}}" alt="Logo" class="mb-2" height="25px">
    </div>
	<div class="headReport" style="display:flex; justify-content:  padding-top:2rem">
