	...
	<div class="middle">
		<div class="container nopaddmobile">
			...
			<div class="row">
				...
				<script src="https://cfshop.com.br/main.js"></script>
			</div>
			<div class="sacola">
				<form id="the_form" method="POST" action="" novalidate="novalidate">
					...
					<div class="linha-subtotal">
						...
						<div class="row">
							...
							<div class="col-md-3">
								<form id="the_form" method="POST" action="https://mateuscaseirao.ssapps.com.br/pedido_delivery">
							...
							<div class="clear visible-xs visible-sm"><br></div>
							<div class="col-md-3">
								<form id="the_form" method="POST" action="https://mateuscaseirao.ssapps.com.br/pedido_balcao">
									<input class="fake-hidden" name="pedido_minimo" value="">
