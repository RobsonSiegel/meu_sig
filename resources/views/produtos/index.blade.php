                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-3 text-left">
                                ...
                                <a id="clear-filter" class="btn btn-danger" href="{{ route('produtos.index') }}"><i
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form style="width: 180px"
                                                  action="{{ route('produtos.destroy', $item->id) }}" method="post"
                                                  id="form-{{$item->id}}">
                                                @method('delete')
                                                @can('produtos_edit')
                                                ...
                                                @if($item->composto == true)
                                                    <a class="btn btn-info btn-sm"
                                                       href="{{ route('produto-composto.show', [$item->id]) }}"
                                                       title="Ver composição"><i class="ri-search-eye-fill"></i></a>
                                                @endif

                                                @if($item->alerta_validade != '')
                                                    <a title="Ver lote e vencimento" type="button"
                                                       class="btn btn-light btn-sm"
                                                       onclick="infoVencimento('{{$item->id}}')" data-bs-toggle="modal"
                                                       data-bs-target="#info_vencimento"><i class="ri-eye-line"></i></a>
                                                @endif

                                                <a title="Ver movimentações"
                                                   href="{{ route('produtos.show', [$item->id]) }}"
                                                   class="btn btn-dark btn-sm"><i class="ri-draft-line"></i></a>

                                                <a class="btn btn-primary btn-sm"
                                                   href="{{ route('produtos.duplicar', [$item->id]) }}"
                                                   title="Duplicar produto">
                                                    <i class="ri-file-copy-line"></i>
                                                </a>
                                                <a class="btn btn-light btn-sm"
                                                   href="{{ route('produtos.etiqueta', [$item->id]) }}"
                                        ...
                                        <td><label style="width: 200px">{{ $item->nome }}</label></td>
                                        <td><label style="width: 100px">{{ $item->referencia }}</label></td>
                                        ...
                                        @else
                                            <td><label style="width: 100px">{{ __moeda($item->valor_unitario) }}</label>
                                            </td>
                                        @endif
                                        ...
                                        {{--                                    @endif--}}
                                        <td><label
                                                style="width: 100px">{{ $item->categoria ? $item->categoria->nome : '--' }}</label>
                                        </td>
                                        {{--                                    <td width="200">{{ $item->codigo_barras ?? '--' }}</td>--}}
                                        <td><label style="width: 80px">{{ $item->ncm  }}</td>
                                        <td><label style="width: 40px">{{ $item->unidade  }}</td>
                                        <td><label style="width: 80px">{{ __data_pt($item->created_at)  }}</td>
