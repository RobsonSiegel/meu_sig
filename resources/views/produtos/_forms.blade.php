        ...
        <div class="tab-pane" id="tab-identificacao">
            <div class="row g-2">
                ...
                <div class="col-md-2">
                    ...
                    <div class="input-group input-group-merge" style="margin-top: -8px">
                        <input type="text" name="codigo_barras"
                               value="{{ isset($item) ? $item->codigo_barras : old('codigo_barras') }}"
                               id="codigo_barras" class="form-control">
                ...
                <div class="col-md-2">
                    ...
                    <div class="input-group input-group-merge" style="margin-top: -8px">
                        <input type="text" name="codigo_barras2"
                               value="{{ isset($item) ? $item->codigo_barras2 : old('codigo_barras2') }}"
                               id="codigo_barras2" class="form-control">
                        <div class="input-group-text">
                ...
                <div class="col-md-2">
                    ...
                    <div class="input-group input-group-merge" style="margin-top: -8px">
                        <input type="text" name="codigo_barras3"
                               value="{{ isset($item) ? $item->codigo_barras3 : old('codigo_barras3') }}"
                               id="codigo_barras3" class="form-control">
                        <div class="input-group-text">
                    ...
                    <div class="input-group flex-nowrap">
                        <select class="select2" name="categoria_id" id="categoria_id">
                            ...
                            @foreach($categorias as $c)
                                <option @isset($item) @if($item->categoria_id == $c->id) selected
                                        @endif @endif value="{{ $c->id}}">{{ $c->nome }}</option>
                            @endforeach
                        </select>
                        <button class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#modal_categoria_produto"
                                type="button">
                ...
                <div class="col-md-3">
                    ...
                    <div class="input-group flex-nowrap">
                        <select class="select2" name="marca_id" id="marca_id">
                            <option value="">Selecione</option>
                            @foreach($marcas as $m)
                                <option @isset($item) @if($item->marca_id == $m->id) selected
                                        @endif @endif value="{{ $m->id}}">{{ $m->nome }}</option>
                            @endforeach
                        </select>
                ...
                @if(__countLocalAtivo() > 1)
                    <div class="col-md-4">
                        ...
                        <select required class="select2 form-control select2-multiple" data-toggle="select2"
                                name="locais[]" multiple="multiple">
                            @foreach(__getLocaisAtivoUsuario() as $local)
                                <option
                                    @if(in_array($local->id, (isset($item) ? $item->locais->pluck('localizacao_id')->toArray() : []))) selected
                                    @endif value="{{ $local->id }}">{{ $local->descricao }}</option>
                            @endforeach
                        </select>
                    </div>
                @else
                                                    ...
                                                    <tr class="dynamic-form">
                                                        ...
                                                        <td>
                                                            <input type="text" class="form-control"
                                                                   ...
                                                                   value="{{ $v->descricao }}" required readonly>
                                                        </td>
                                                        <td>
                                                            <input type="tel" class="form-control"
                                                                   name="estoque_variacao[]"
                                                                   value="{{ $v->estoque_variacao }}">
                                                        </td>
                                                        <td>
                                                            <input type="tel" class="form-control moeda"
                                                                   name="valor_venda_variacao[]"
                                                                   value="{{ __moeda($v->valor) }}" required>
                                                        </td>
                                                        <td>
                                                            <input type="tel" class="form-control ignore"
                                                                   name="codigo_barras_variacao[]"
                                                                   value="{{ $v->codigo_barras }}">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="form-control ignore"
                                                                   name="referencia_variacao[]"
                                                                   value="{{ $v->referencia }}">
                                                        </td>
                                                        <td>
                                                            <input class="ignore" accept="image/*" type="file"
                                                                   class="form-control" name="imagem_variacao[]"
                                                                   value="">
                                                        ...
                                                        <td>
                                                            <button type="button"
                                                                    class="btn btn-sm btn-danger btn-remove-tr-variacao">
                                ...
                                @foreach($item->itensDoCombo as $c)
                                    <tr class="dynamic-form">
                                        ...
                                        <td style="width: 120px">
                                            <input type="tel" class="form-control qtd-combo quantidade"
                                                   name="quantidade_combo[]"
                                                   value="{{ $c->quantidade }}">
                                        </td>
                                        <td>
                                            <input type="tel" class="form-control moeda valor-compra-combo"
                                                   name="valor_compra_combo[]" value="{{ __moeda($c->valor_compra) }}">
                                        </td>
                                        <td>
                                            <input type="tel" class="form-control moeda subtotal-combo"
                                                   name="subtotal_combo[]" value="{{ __moeda($c->sub_total) }}">
                                        </td>
                                        <td>
                ...
                <div class="card col-md-3 mt-3 form-input">
                    <div class="preview">
                        <button type="button" id="btn-remove-imagem" class="btn btn-link-danger btn-sm btn-danger">x
                        </button>
                        @isset($item)
                    ...
                    @isset($item)
                        <a class="btn btn-danger btn-sm w-50 mt-2 mb-1"
                           href="{{ route('produtos.remove-image', [$item->id])}}">
    ...
    <div class="tab-content b-0 mb-0">
        <div class="tab-pane" id="tab-outros">
            <div class="row g-2">
                            ...
                            <div class="card-header">
                                <h4>
                                    <div class="form-check form-switch">
                                        <input type="checkbox" class="form-check-input" id="inp-petroleo"
                                               @isset($item) @if($item->codigo_anp != '') checked @endif @endif>
                                        <strong>Derivado do petróleo</strong>
                                    </div>
                                </h4>
                            </div>
                                ...
                                <div class="card-header">
                                    <h4>
                                        ...
                                        <div class="form-check form-switch form-checkbox-danger">
                                            <input type="checkbox" name="cardapio" class="form-check-input"
                                                   id="inp-cardapio" @isset($item) @if($item->cardapio) checked
                                                   @endif @endif @isset($cardapio) @if($cardapio == 1) checked @endif @endif ><strong>Cardápio</strong>
                                        </div>
                                    </h4>
                                </div>
                                    ...
                                    <h4>
                                        ...
                                        <div class="form-check form-switch form-checkbox-success">
                                            <input type="checkbox" name="delivery" class="form-check-input"
                                                   id="inp-delivery" @isset($item) @if($item->delivery) checked
                                                   @endif @endif @isset($delivery) @if($delivery == 1) checked @endif @endif ><strong>Delivery/MarketPlace</strong>
                                        </div>
                                    </h4>
                                </div>
                ...
                @if(__isActivePlan(Auth::user()->empresa, 'Chapas'))
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4>
                                        @isset($chapa)
                                            @if($chapa == 1)
                                                <input type="hidden" name="redirect_chapa" value="1">
                                            @endif
                                        @endif
                                        <div class="form-check form-switch form-checkbox-success">
                                            <input type="checkbox" name="chapa" class="form-check-input"
                                                   id="inp-chapa" @isset($item) @if($item->chapa) checked
                                                   @endif @endif @isset($chapa) @if($chapa == 1) checked @endif @endif ><strong>Chapas e Dobras</strong>
                                        </div>
                                    </h4>
                                </div>
                                <div class="card-body div-chapa d-none m-card" style="margin-top: -40px">

                                    <div class="row">
                                        <div class="col-md-2">
                                            {!!Form::tel('peso_chapa', 'Peso (KG)')
                                            ->value((isset($item) && $item->peso > 0) ? __moeda($item->peso) : '0,00')
                                            ->attrs(['class' => 'moeda'])
                                            !!}
                                        </div>

                                        <div class="col-md-2">
                                            {!!Form::tel('largura_chapa', 'Largura (mm)')
                                            ->value((isset($item) && $item->largura > 0) ? __moeda($item->largura) : '0,00')
                                            ->attrs(['class' => 'moeda'])
                                            !!}
                                        </div>

                                        <div class="col-md-2">
                                            {!!Form::tel('comprimento_chapa', 'Comprimento (mm)')
                                            ->value((isset($item) && $item->comprimento > 0) ? __moeda($item->comprimento) : '0,00')
                                            ->attrs(['class' => 'moeda'])
                                            !!}
                                        </div>

                                        <div class="col-md-2">
                                            {!!Form::tel('espessura_chapa', 'Espessura (mm)')
                                            ->value((isset($item) && $item->espessura > 0) ? __moeda($item->espessura) : '0,00')
                                            ->attrs(['class' => 'moeda'])
                                            !!}
                                        </div>

                                        <div class="col-md-2">
                                            {!!Form::tel('diametro_chapa', 'Diâmetro (mm)')
                                            ->value((isset($item) && $item->diametro > 0) ? __moeda($item->diametro) : '0,00')
                                            ->attrs(['class' => 'moeda'])
                                            !!}
                                        </div>
                                    </div>
                                ...
                                <div class="card-header">
                                    <h4>
                                        ...
                                        <div class="form-check form-switch form-checkbox-info">
                                            <input type="checkbox" name="nuvemshop" class="form-check-input"
                                                   id="inp-nuvemshop" @isset($item) @if($item->nuvemshop) checked
                                                   @endif @endif @isset($nuvemshop) @if($nuvemshop == 1) checked @endif @endif ><strong>NuvemShop</strong>
                                        </div>
                                    </h4>
                                </div>
                                <div class="card-body div-nuvemshop d-none m-card" style="margin-top: -40px">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            ...
                                            ->value((isset($item) && $item->nuvem_shop_valor > 0) ? __moeda($item->nuvem_shop_valor) : '')
                                        ...
                                        <div class="col-md-4">
                                            {!!Form::select('categoria_nuvem_shop', 'Categoria')
                                               ->options((isset($item) && $item->nuvem_shop_categoria) ?
                                            [$item->nuvem_shop_categoria => $item->categoria->nome] : [])
                                            !!}
                                        </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h4>
                                            ...
                                            <div class="form-check form-switch form-checkbox-warning">
                                                <input type="checkbox" name="mercadolivre" class="form-check-input"
                                                       id="inp-mercadolivre"
                                                       @isset($item) @if($item->mercado_livre_id != null) checked
                                                       @endif @endif @isset($mercadolivre) @if($mercadolivre == 1) checked @endif @endif ><strong>Mercado
                                                    livre</strong>
                                            </div>
                                        </h4>
                                    </div>
                                    ...
                                    <div class="card-body div-mercadolivre d-none m-card" style="margin-top: -40px">
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="hidden" id="tipo_publicacao_hidden"
                                                   value="{{ isset($item) ? $item->mercado_livre_tipo_publicacao : '' }}">
                                            ...
                                            <div class="col-md-2">
                                                {!!Form::text('mercado_livre_composicao', 'Composição')
                                                ->attrs(['class' => ''])
                                                !!}
                                            </div>
                                            <div class="col-md-2">
                                                {!!Form::text('mercado_livre_linha', 'Linha')
                                                ->attrs(['class' => ''])
                                                !!}
                                            </div>
                                            <div class="col-md-12">
                                    ...
                                    <h4>
                                        ...
                                        <div class="form-check form-switch form-checkbox-info">
                                            <input type="checkbox" name="ecommerce" class="form-check-input"
                                                   id="inp-ecommerce" @isset($item) @if($item->ecommerce) checked
                                                   @endif @endif @isset($ecommerce) @if($ecommerce == 1) checked @endif @endif ><strong>Ecommerce</strong>
                                        </div>
                                    </h4>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h4>
                                        ...
                                        @endif
                                        <div class="form-check form-switch form-checkbox-danger">
                                            <input type="checkbox" name="reserva" class="form-check-input"
                                                   id="inp-reserva" @isset($item) @if($item->reserva) checked
                                                   @endif @endif @isset($reserva) @if($reserva == 1) checked @endif @endif ><strong>Reserva</strong>
                                        </div>
                                    </h4>
                                </div>
                            </div>
                                ...
                                <div class="card-header">
                                    <h4>
                                        ...
                                        <div class="form-check form-switch form-checkbox-dark">
                                            <input type="checkbox" name="woocommerce" class="form-check-input"
                                                   id="inp-woocommerce" @isset($item) @if($item->woocommerce) checked
                                                   @endif @endif @isset($woocommerce) @if($woocommerce == 1) checked @endif @endif ><strong>Woocommerce</strong>
                                        </div>
                                    </h4>
                                </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="select2 form-control select2-multiple"
                                                        name="categorias_woocommerce[]" multiple="multiple"
                                                        id="categorias_woocommerce">
