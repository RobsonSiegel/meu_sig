@extends('layouts.app', ['title' => 'Informação de Recebimento'])
@section('content')
<div class="mt-3">
    <div class="row">
        <div class="card">
            <div class="card-body">
                ...
                <h3>Produtos da Compra: {{$compra->id}} do fornecedor: {{$compra->fornecedor->razao_social}}</h3>
                {!!Form::open()
                ->post()
                ->route('compras.setar-info-recebimento')
                !!}
                        ...
                        <table class="table table-striped table-centered mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="col-2">
                                        <input value="{{ __moeda($item->valor_unitario) }}" class="form-control moeda valor_unit" type="tel" name="valor_unitario[]" id="valor_unit">
                                    </td>
                                    <td class="col-2">
