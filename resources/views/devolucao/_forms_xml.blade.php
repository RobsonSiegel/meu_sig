                                ...
                                <tbody>
                                    ...
                                    <tr class="dynamic-form">
                                        ...
                                        <td style="width: 500px">
                                            ...
                                            <input class="form-control" name="nome_produto[]" type="text" value="{{ $prod->xProd }}" style="width: 500px">
                                            @if($prod->id == 0)
                                    ...
                                    <tr class="dynamic-form">
                                        ...
                                        <td style="width: 500px">
                                            ...
                                            <input class="form-control" name="nome_produto[]" type="text" value="{{ $prod->produto->nome }}" style="width: 500px">
                                        </td>
                                        <td width="120">
                                            <input style="width: 120px" value="{{ __moeda($prod->quantidade) }}" class="form-control qtd" type="tel" name="quantidade[]" id="inp-quantidade">
                                        </td>
