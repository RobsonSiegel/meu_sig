                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row mt-3 g-1">
                            ...
                            <div class="col-lg-4 col-12">
                                ...
                                <a id="clear-filter" class="btn btn-danger" href="{{ route('devolucao.index') }}"><i
                            ...
                            <table class="table table-striped table-centered mb-0">
                                ...
                                @forelse($data as $item)
                                    <tr>
                                        ...
                                        @if($item->cliente)
                                            <td><label
                                                    style="width: 300px">{{ $item->cliente ? $item->cliente->razao_social : "--" }}</label>
                                            </td>
                                            <td><label
                                                    style="width: 150px">{{ $item->cliente ? $item->cliente->cpf_cnpj : "--" }}</label>
                                            </td>
                                        @else
                                            <td><label
                                                    style="width: 300px">{{ $item->fornecedor ? $item->fornecedor->razao_social : "--" }}</label>
                                            </td>
                                            <td><label
                                                    style="width: 150px">{{ $item->fornecedor ? $item->fornecedor->cpf_cnpj : "--" }}</label>
                                            </td>
                                        @endif
                                        @if(__countLocalAtivo() > 1)
                                        ...
                                        <td>
                                            <form action="{{ route('devolucao.destroy', $item->id) }}" method="post"
                                                  id="form-{{$item->id}}" style="width: 360px">
                                                @method('delete')
                                                @csrf
                                                ...
                                                @if($item->estado == 'novo' || $item->estado == 'rejeitado')
                                                    ...
                                                    @can('devolucao_edit')
                                                        <a class="btn btn-warning btn-sm"
                                                           href="{{ route('devolucao.edit', $item->id) }}">
                                                    ...
                                                    @can('devolucao_delete')
                                                        <button title="Remover devolução" type="button"
                                                ...
                                                @if(__isPlanoFiscal())
                                                    @can('devolucao_edit')
                                                        <a title="Alterar estado fiscal devolução"
                                                           class="btn btn-danger btn-sm"
                                                           href="{{ route('nfe.alterar-estado', [$item->id, 'tipo=devolucao']) }}">
