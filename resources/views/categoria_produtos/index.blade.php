                ...
                <div class="card-body">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-3 text-left ">
                                ...
                                <a id="clear-filter" class="btn btn-danger"
                                   href="{{ route('categoria-produtos.index') }}"><i
                    ...
                    <div class="col-md-12 mt-3">
                        <div class="table-responsive-sm">
                            <table class="table table-striped table-centered mb-0">
                                ...
                                @forelse($data as $item)
                                    <tr>
                                        ...
                                        @endif
                                        <td>
                                            <form action="{{ route('categoria-produtos.destroy', $item->id) }}"
                                                  method="post" id="form-{{$item->id}}" style="width: 150px">
                                                @method('delete')
                                                @can('categoria_produtos_edit')
                                                    <a class="btn btn-warning btn-sm text-white"
                                                       href="{{ route('categoria-produtos.edit', [$item->id]) }}">
                            ...
                            <br>
                            @can('categoria_produtos_delete')
                                <form action="{{ route('categoria-produtos.destroy-select') }}" method="post"
