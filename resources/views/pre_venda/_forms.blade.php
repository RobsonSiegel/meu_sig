                    ...
                    <div class="card widget-icon-box div-pagamento" style="height: 93%">
                        <div class="card-body">
                            <div class="d- mt-3">
                                ...
                                <div class="avatar-sm flex-shrink-0">
                                    <button type="button" class="avatar-title text-bg-warning rounded rounded-3 fs-3 widget-icon-box-avatar shadow pagamento_multiplo" data-bs-toggle="modals" data-bs-target="#pagamento_multiplo">
