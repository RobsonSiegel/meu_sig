...
ALTER TABLE `movimentacao_produtos` CHANGE `tipo_transacao` `tipo_transacao` ENUM('venda_nfe','venda_nfce','compra','alteracao_estoque','contagem_estoque', 'cancela_nfce') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL;
/* Insert de Permissões de Cadastro de Máquinas */
...
ALTER TABLE `produtos` ADD `chapa` TINYINT(1) NULL DEFAULT '0' AFTER `ecommerce`;
ALTER TABLE `produtos` ADD `espessura` DECIMAL(8,2) NULL DEFAULT NULL AFTER `peso`, ADD `diametro` DECIMAL(8,2) NULL DEFAULT NULL AFTER `espessura`;
